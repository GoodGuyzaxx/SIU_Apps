            ...
            return $schema
                ->components([
                            ...
                            Grid::make(1)
                                ->schema([
                                    Select::make('minat_kekuhusan')
                                        ...
                                        ->helperText('Pilih bidang hukum yang paling Anda minati')
                                        ->live()
                                        ->columnSpanFull(),
                                    ...
                                    Placeholder::make('minat_description')
                                        ->label('')
                                        ->content(fn ($get) => match($get('minat_kekuhusan')) {
                                            'HTN' => 'Hukum Tata Negara Mempelajari konstitusi, struktur pemerintahan, hubungan antar lembaga negara, dan hak asasi manusia.',
                                            'Hukum Pidana' => 'Mempelajari tindak pidana, sanksi hukum, sistem peradilan pidana, dan penegakan hukum',
                                            'Hukum Perdata' => 'Mempelajari hubungan hukum antar individu, kontrak, warisan, dan kepemilikan.',
                                            default => ''
                                        })
                    ...
                    Section::make()
                            ...
                            Grid::make(1)
                                ->schema([
                                    Textarea::make('judul_satu')
                                        ->label('📌 Prioritas 1')
                                        ->placeholder('Contoh: Analisis Hukum Terhadap Implementasi Peraturan...')
                                        ->required()
                                        ->minLength(10)
                                        ->maxLength(500)
                                        ->rows(3)
                                        ->autosize()
                                        ->helperText(fn ($get) => (strlen($get('judul_satu') ?? '') . '/500 karakter'))
                                        ->live(onBlur: true)
                                        ->columnSpanFull(),
                                ])
                                ->extraAttributes(['class' => 'p-4 bg-primary-50 dark:bg-primary-900/10 rounded-lg']),
                            ...
                            Grid::make(1)
                                ->schema([
                                    Textarea::make('judul_dua')
                                        ->label('📌 Prioritas 2')
                                        ->placeholder('Contoh: Tinjauan Yuridis Mengenai...')
                                        ->required()
                                        ->minLength(10)
                                        ->maxLength(500)
                                        ->rows(3)
                                        ->autosize()
                                        ->helperText(fn ($get) => (strlen($get('judul_dua') ?? '') . '/500 karakter'))
                                        ->live(onBlur: true)
                                        ->columnSpanFull(),
                                ])
                                ->extraAttributes(['class' => 'p-4 bg-gray-50 dark:bg-gray-900/10 rounded-lg']),
                            ...
                            Grid::make(1)
                                ->schema([
                                    Textarea::make('judul_tiga')
                                        ->label('📌 Prioritas 3')
                                        ->placeholder('Contoh: Implementasi dan Penerapan...')
                                        ->required()
                                        ->minLength(10)
                                        ->maxLength(500)
                                        ->rows(3)
                                        ->autosize()
                                        ->helperText(fn ($get) => (strlen($get('judul_tiga') ?? '') . '/500 karakter'))
                                        ->live(onBlur: true)
                                        ->columnSpanFull(),
                                ])
                                ->extraAttributes(['class' => 'p-4 bg-gray-50 dark:bg-gray-900/10 rounded-lg']),
                        ...
                        ->description('Masukkan 3 usulan judul penelitian sesuai prioritas')
